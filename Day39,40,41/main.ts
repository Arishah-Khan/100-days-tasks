...
function DaysOfWeek (NumberOfDays:number):void {
    switch (NumberOfDays) {
        case 1:
            console.log("Sunday");
            break;
...
function DefaultCase (grade:string){
    switch (grade) {
        case "A":
...
let favouriteMovie:string[]  = ["Zero Dark Thirty","A Beautiful Mind","The Impossible","The Secret Life of Walter Mitty"];

...
let ingredients:number = 12;

// Creating a message about the recipe:

let recipe:string = `"The recipe requires ${ingredients} ingredients."`;
...
let myName:string[] = ["Ayesha","Nimra","Maheen","Aizal","Meerab","Kinza"];
...
let names:string[] = ["Ayesha","Nimra","Maheen","Aizal","Meerab","Kinza"];

let message0:string = "Hope your day is as awesome as you are!";
console.log(`\"Hello ${names[0]}! ${message0}\"`);

let message1:string = "How's it going?";
console.log(`\"Hey ${names[1]}! ${message1}\"`);

let message2:string = "Let's catch up soon,";
console.log(`\"Greetings, ${names[2]}! ${message2}\"`);

let message3:string = "Wishing you a fantastic day ahead.";
console.log(`Hey, ${names[3]}! ${message3}`);

let message4:string = "It's always great to see your smiling face.";
console.log(`\"Hi ${names[4]}! ${message4}\"`);

let message5:string = "How are you doing today,";
...
let transportation:string[] = ["Honda Civic","BMW","Suzuki Alto","Toyota Carolla"];
...
let guest_List:string[] = ["Kiran","Ajwa","Tasmiya","Zimal","Laiba"];

...
let famous_person:string = "Alexander Graham Bell";

let quote:string = "“Concentrate all your thoughts upon the work in hand. The sun’s rays do not burn until brought to a focus.”";
